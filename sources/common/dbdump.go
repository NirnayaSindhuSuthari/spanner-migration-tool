...
func ProcessDbDump(SpProjectId string, SpInstanceId string, conv *internal.Conv, r *internal.Reader, dbDump DbDump) error {
	...
	if conv.SchemaMode() {
		...
		// SpProjectId := 
		// SpInstanceId := 
		schemaToSpanner.SchemaToSpannerDDL(SpProjectId, SpInstanceId, conv, dbDump.GetToDdl())
		conv.AddPrimaryKeys()
	}
	return nil
}
