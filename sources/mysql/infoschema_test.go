	...
	ms := []mockSpec{

		{
			...
			rows: [][]driver.Value{
				...
				{"defval_1", "varchar", "varchar", "YES", "_utf8mb4\\'John\\'", nil, nil, nil, nil}},
		},
		...
		},
		{
			...
			rows: [][]driver.Value{
				...
				{"defval_2", "varchar", "varchar", "YES", "_utf8mb4\\'John\\'", nil, nil, nil, nil}},
		},
		// db call to fetch index happens after fetching of column
		{
			query: "SELECT (.+) FROM INFORMATION_SCHEMA.STATISTICS (.+)",
		...
		},
		{
			...
			rows: [][]driver.Value{
				...
				{"defval_3", "varchar", "varchar", "YES", "_utf8mb4\\'John\\'", nil, nil, nil, nil}},
		},
		// db call to fetch index happens after fetching of column
		{
			query: "SELECT (.+) FROM INFORMATION_SCHEMA.STATISTICS (.+)",
		...
		},
		{
			...
			rows: [][]driver.Value{
				...
				{"def", "varchar", "varchar", "YES", "_utf8mb4\\'John\\'", nil, nil, nil, nil}},
		},
		// db call to fetch index happens after fetching of column
		{
			query: "SELECT (.+) FROM INFORMATION_SCHEMA.STATISTICS (.+)",
		...
		},
		{
			...
			rows: [][]driver.Value{
				...
				{"defval_4", "varchar", "varchar", "YES", "_utf8mb4\\'John\\'", nil, nil, nil, nil}},
		},
		// db call to fetch index happens after fetching of column
		{
			query: "SELECT (.+) FROM INFORMATION_SCHEMA.STATISTICS (.+)",
